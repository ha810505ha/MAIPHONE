...
const [settings, mailbox, app] = await Promise.all([
...
assert(app.includes("mailboxUnreadCount={countUnreadMails(mailboxMails)}"), "the settings tabs must receive live mailbox state");
