...
assert.deepEqual(
  getGoogleSignInConfig({ VITE_GOOGLE_AUTH_WEB_CLIENT_ID: "google-client.apps.googleusercontent.com" }),
  { webClientId: "google-client.apps.googleusercontent.com", configured: true },
);
