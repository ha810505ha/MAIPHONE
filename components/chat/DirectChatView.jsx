...
import CalendarDueCard from "./CalendarDueCard";
import ChatStoryStatus from "./ChatStoryStatus";
import ChatStoryNoteFloat from "./ChatStoryNoteFloat";
    ...
    <div className="mp-page" onClick={onPageClick}>
      ...
      {settingsOpen ? (
        ...
        <>
          ...
          <CalendarDueCard {...calendarReminder} tr={tr} />
          {storyStatus && <ChatStoryStatus {...storyStatus} tr={tr} />}
          <ChatStoryNoteFloat {...storyNote} tr={tr} />
