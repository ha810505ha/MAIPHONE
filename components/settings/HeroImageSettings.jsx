    ...
    <div className="mp-sg" style={{ padding: 12, margin: "10px 0", order: 2 }}>
      ...
      {!heroDraft ? (
        <div style={{ display: "flex", gap: 8 }}>
          ...
          {(activeChar.heroImage || activeChar.avatarOriginal || activeChar.avatar) && <button className="mp-ibtn" onClick={beginHeroEdit}>{tr("調整顯示位置", "Adjust position", "表示位置を調整", "표시 위치 조정")}</button>}
