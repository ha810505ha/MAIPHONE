...
import { cropById, plantCrop } from "../systems/farm";
...
export default function YunyinPanelHost({ panel, setPanel, gameSave, markDirty, onCompanion, showToast, addCrystals, crystals = 0, characters, onAiGenerate, npcAppearanceRef, coins, onHomeRefresh }) {
