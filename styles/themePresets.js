const THEME_PRESETS = {
  ...
  "夜色絨幕": {
    ...
    vars: {
      ...
      "--mp-rt-strong": "#F09CB8",
      "--mp-info": "#A5C9E8",
      "--mp-wallet-life-bg": "linear-gradient(135deg,#C5D1D3 0%,#ADB8C2 100%)",
      "--mp-wallet-life-border": "#8EA99F",
      "--mp-wallet-crystal-bg": "linear-gradient(135deg,#CAD8E7 0%,#BFB7D6 100%)",
      "--mp-wallet-light-card-text": "#302A3B",
      "--mp-wallet-light-card-muted": "#4D455A",
      "--mp-wallet-crystal-link": "#29495E",
      "--mp-wallet-list-muted": "#C7BBD2",
      "--mp-r": "20px",
      "--mp-rs": "12px",
      "--mp-rx": "8px",
      "--mp-font": "'Zen Maru Gothic','Quicksand',sans-serif",
